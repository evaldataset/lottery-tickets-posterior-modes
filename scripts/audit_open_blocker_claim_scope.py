...
GROUPS = [
    ...
    },
    {
        ...
        "blockers": [
            ...
            # Transient in-progress flag: surfaces while the release archive
            # is mid-rebuild during a remediation cycle; clears when the
            # smoke re-passes. Classified here so the cycle is auditable
            # rather than reported as an unclassified blocker.
