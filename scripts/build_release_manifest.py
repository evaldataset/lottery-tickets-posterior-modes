...
EXCLUDED = {
    ...
    # These two aggregate the same mutable post-release receipt state (their
    # open-risk sets clear when receipts are recorded), so they would tie the
    # archive SHA to the receipt registry and break the fixed point.
