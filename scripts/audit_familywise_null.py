...
FAMILY_SOURCES = [
    ...
    ("deep_ensemble", "runs/cifar10_resnet20_long30_rewind1_mode_ticket_distribution_deep_ensemble_r5_p0p3_summary.csv"),
    ("tempered_sgld", "runs/cifar10_resnet20_long30_rewind1_mode_ticket_distribution_tempered_sgld_r5_p0p3_summary.csv"),
]
