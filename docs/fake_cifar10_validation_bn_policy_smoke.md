...
- Run: `runs/fake_cifar10_validation_bn_policy_smoke/20260513_145944`
- Dataset/model: `fake-cifar10` / `resnet20`
- Seeds: `[0]`; data seed `0`
- Evaluation split: `val`; validation fraction `0.25`; subset strategy `seeded`
...
- Posterior-to-chain-start Hamming mean: 0.0023; sample accuracy mean 0.0000; chain-start accuracy mean 0.1250

| Comparison | n left | n tickets | KS p | MMD | SW2 | Hamming overlap | Logit CKA | Act. CKA | H-cost | Act. H-cost | Threshold pass count |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| chain_start_magnitude_vs_tickets | 1 | 1 | 1.0000 | 0.7869 | 0.0075 | nan | 0.7314 | 0.7432 | 0.2686 | 0.2568 | 3/6 |
| posterior_samples_vs_tickets | 1 | 1 | 1.0000 | 0.7869 | 0.0070 | nan | 0.2612 | 0.1882 | 0.7388 | 0.8118 | 1/6 |
| posterior_modes_vs_tickets | 1 | 1 | 1.0000 | 0.7869 | 0.0070 | nan | 0.2612 | 0.1882 | 0.7388 | 0.8118 | 1/6 |
