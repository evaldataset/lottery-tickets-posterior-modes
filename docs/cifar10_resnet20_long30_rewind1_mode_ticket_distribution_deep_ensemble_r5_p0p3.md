...
- Run: `runs/cifar10_resnet20_long30_rewind1_mode_ticket_distribution_deep_ensemble_r5_p0p3/20260611_013605`
...
- Posterior sampler: `deep-ensemble` with 2 samples per chain, 1 chain(s) per seed from `dense` starts
...
- Posterior-to-chain-start Hamming mean: 0.2415; sample accuracy mean 0.8799; chain-start accuracy mean 0.8823
...
| posterior_samples_vs_tickets | 10 | 5 | 0.0000 | 1.6709 | 0.0784 | 0.0000 | 0.9312 | 0.9107 | 0.0688 | 0.0893 | 4/6 |
| posterior_modes_vs_tickets | 1 | 5 | 0.0329 | 1.7402 | 0.0903 | nan | 0.9289 | 0.9055 | 0.0711 | 0.0945 | 4/6 |
